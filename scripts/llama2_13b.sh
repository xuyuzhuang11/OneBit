...
#SBATCH --output=output_llama2_13b.txt


MODEL_NAME=llama2_13b
SCRIPT_DIR=$(dirname "$0")
DATASET=kd_132k
TEACHER_MODEL_PATH=/home/xyz/models/llama2-13b
...
deepspeed --num_gpus 8 --master_port=9901 --hostfile="$SCRIPT_DIR/hostfile" train_bash.py \
